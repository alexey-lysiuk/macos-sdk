...
# build directory.
TCL_BUILD_LIB_SPEC='-F/private/var/tmp/tcl/tcl-102~350/OBJROOT1/tcl84/Deployment -framework Tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/private/var/tmp/tcl/tcl-102~350/OBJROOT1/tcl84/Deployment -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/private/var/tmp/tcl/tcl-102~350/OBJROOT1/tcl84/Deployment/libtclstub8.4${TCL_DBGX}.a'
