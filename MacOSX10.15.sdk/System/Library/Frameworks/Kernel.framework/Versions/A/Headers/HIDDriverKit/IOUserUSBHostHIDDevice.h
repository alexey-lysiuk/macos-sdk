/* iig(DriverKit-54.0.0.110.1) generated from IOUserUSBHostHIDDevice.iig */
...
\
    kern_return_t\
    CompleteInputReport_Invoke(const IORPC rpc,\
        void (IOUserUSBHostHIDDevice::*func)(IOUserUSBHostHIDDevice_CompleteInputReport_Args));\
\
    kern_return_t\
    TimerOccurred_Invoke(const IORPC rpc,\
        void (IOUserUSBHostHIDDevice::*func)(IOUserUSBHostHIDDevice_TimerOccurred_Args));\
\
    kern_return_t\
    CompleteZLP_Invoke(const IORPC rpc,\
        void (IOUserUSBHostHIDDevice::*func)(IOUserUSBHostHIDDevice_CompleteZLP_Args));\
\
...
extern OSClassLoadInformation IOUserUSBHostHIDDevice_Class;
