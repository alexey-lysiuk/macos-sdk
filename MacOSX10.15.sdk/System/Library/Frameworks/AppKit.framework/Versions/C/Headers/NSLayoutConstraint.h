...
typedef NS_ENUM(NSInteger, NSLayoutAttribute) {
    ...
    NSLayoutAttributeFirstBaseline API_AVAILABLE(macos(10.11)),
...
typedef NS_OPTIONS(NSUInteger, NSLayoutFormatOptions) {        
    ...
    NSLayoutFormatAlignAllFirstBaseline API_AVAILABLE(macos(10.11)) = (1 << NSLayoutAttributeFirstBaseline),
