...
typedef NS_OPTIONS(NSUInteger, NSTextStorageEditActions) {
    NSTextStorageEditedAttributes API_AVAILABLE(macos(10.0), ios(7.0)) = (1 << 0),
    NSTextStorageEditedCharacters API_AVAILABLE(macos(10.0), ios(7.0)) = (1 << 1)
...
API_AVAILABLE(macos(10.0), ios(7.0)) @interface NSTextStorage : NSMutableAttributedString <NSSecureCoding>
