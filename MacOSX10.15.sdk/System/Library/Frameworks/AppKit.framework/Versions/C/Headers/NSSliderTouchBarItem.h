...
typedef CGFloat NSSliderAccessoryWidth NS_TYPED_EXTENSIBLE_ENUM API_AVAILABLE(macos(10.12.2)) API_AVAILABLE(ios(13.0));
/// The default width for slider accessories.
APPKIT_EXTERN const NSSliderAccessoryWidth NSSliderAccessoryWidthDefault API_AVAILABLE(macos(10.12.2)) API_AVAILABLE(ios(13.0));
/// The standard "wide" width for slider accessories.
APPKIT_EXTERN const NSSliderAccessoryWidth NSSliderAccessoryWidthWide API_AVAILABLE(macos(10.12.2)) API_AVAILABLE(ios(13.0));
