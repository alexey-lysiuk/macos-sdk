...
- (nullable NSImage *)imageForBounds:(NSRect)imageBounds textContainer:(nullable NSTextContainer *)textContainer characterIndex:(NSUInteger)charIndex  API_AVAILABLE(macos(10.11));
...
API_AVAILABLE(macos(10.0), ios(7.0)) @interface NSTextAttachment : NSObject <NSTextAttachmentContainer, NSSecureCoding>
...
@property (nullable, strong) NSImage *image API_AVAILABLE(macos(10.11));
