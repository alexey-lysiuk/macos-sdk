...
API_AVAILABLE(macos(10.0), ios(7.0)) @interface NSTextTab : NSObject <NSCopying, NSCoding, NSSecureCoding>
...
API_AVAILABLE(macos(10.0), ios(6.0)) @interface NSParagraphStyle : NSObject <NSCopying, NSMutableCopying, NSSecureCoding>
...
API_AVAILABLE(macos(10.0), ios(6.0)) @interface NSMutableParagraphStyle : NSParagraphStyle
