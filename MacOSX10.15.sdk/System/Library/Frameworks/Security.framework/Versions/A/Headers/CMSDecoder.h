...
OSStatus CMSDecoderSetSearchKeychain(
    ...
    API_DEPRECATED_WITH_REPLACEMENT("SecKeychainSetSearchList",macos(10.5, 10.13)) API_UNAVAILABLE(ios, watchos, tvos, uikitformac);
#endif // SEC_OS_OSX
...
OSStatus CMSDecoderCopySignerSigningTime(
    ...
    __API_AVAILABLE(macos(10.8)) API_UNAVAILABLE(ios, tvos, watchos, uikitformac);
