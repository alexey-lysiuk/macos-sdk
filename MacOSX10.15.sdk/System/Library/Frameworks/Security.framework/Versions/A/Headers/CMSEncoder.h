...
CFTypeID CMSEncoderGetTypeID(void)
    __API_AVAILABLE(macos(10.5)) API_UNAVAILABLE(ios, tvos, watchos, uikitformac);
...
OSStatus CMSEncoderSetSignerAlgorithm(
    ...
    __API_AVAILABLE(macos(10.11)) API_UNAVAILABLE(ios, tvos, watchos, uikitformac);
...
OSStatus CMSEncoderSetEncapsulatedContentType(
    ...
    API_DEPRECATED_WITH_REPLACEMENT("CMSEncoderSetEncapsulatedContentTypeOID", macos(10.5, 10.7)) API_UNAVAILABLE(ios, watchos, tvos, uikitformac);
#endif // SEC_OS_OSX
...
OSStatus CMSEncoderSetEncapsulatedContentTypeOID(
    ...
    __API_AVAILABLE(macos(10.7)) API_UNAVAILABLE(ios, tvos, watchos, uikitformac);
...
OSStatus CMSEncode(
    ...
    size_t                      contentLen,
    CFDataRef * __nonnull CF_RETURNS_RETAINED encodedContentOut)    /* RETURNED */
    API_DEPRECATED_WITH_REPLACEMENT("CMSEncodeContent", macos(10.5, 10.7)) API_UNAVAILABLE(ios, watchos, tvos, uikitformac);
#endif // TARGET_OS_OSX
...
OSStatus CMSEncoderCopySignerTimestamp(
    ...
    API_AVAILABLE(macos(10.8)) API_UNAVAILABLE(ios, watchos, tvos, uikitformac);
...
OSStatus CMSEncoderCopySignerTimestampWithPolicy(
    ...
    size_t                  signerIndex,        /* usually 0 */
    CFAbsoluteTime          *timestamp)			/* RETURNED */
    API_AVAILABLE(macos(10.10)) API_UNAVAILABLE(ios, watchos, tvos, uikitformac);
