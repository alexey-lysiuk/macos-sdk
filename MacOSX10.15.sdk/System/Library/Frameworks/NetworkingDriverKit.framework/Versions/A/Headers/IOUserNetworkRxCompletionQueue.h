/* iig(DriverKit-54.0.0.111.1) generated from IOUserNetworkRxCompletionQueue.iig */
...
\
    ...
    Create_Invoke(const IORPC rpc,\
        kern_return_t (*func)(IOUserNetworkRxCompletionQueue_Create_Args));\
\
...
extern OSClassLoadInformation IOUserNetworkRxCompletionQueue_Class;
