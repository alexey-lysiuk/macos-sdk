/* iig(DriverKit-54.0.0.111.1) generated from IOUserNetworkTxCompletionQueue.iig */
...
\
    ...
    Create_Invoke(const IORPC rpc,\
        kern_return_t (*func)(IOUserNetworkTxCompletionQueue_Create_Args));\
\
...
extern OSClassLoadInformation IOUserNetworkTxCompletionQueue_Class;
