/* iig(DriverKit-54.0.0.111.1) generated from IOUserNetworkRxSubmissionQueue.iig */
...
\
    ...
    Create_Invoke(const IORPC rpc,\
        kern_return_t (*func)(IOUserNetworkRxSubmissionQueue_Create_Args));\
\
...
extern OSClassLoadInformation IOUserNetworkRxSubmissionQueue_Class;
