/* iig(DriverKit-54.0.0.111.1) generated from IOUserNetworkPacketBufferPool.iig */
...
\
    ...
    _DeallocatePacket_Invoke(const IORPC rpc,\
        kern_return_t (IOUserNetworkPacketBufferPool::*func)(IOUserNetworkPacketBufferPool__DeallocatePacket_Args));\
\
    kern_return_t\
    _CopyPacketWithIndex_Invoke(const IORPC rpc,\
        kern_return_t (IOUserNetworkPacketBufferPool::*func)(IOUserNetworkPacketBufferPool__CopyPacketWithIndex_Args));\
\
    static kern_return_t\
    Create_Invoke(const IORPC rpc,\
        kern_return_t (*func)(IOUserNetworkPacketBufferPool_Create_Args));\
\
    kern_return_t\
    CopyMemoryDescriptor_Invoke(const IORPC rpc,\
        kern_return_t (IOUserNetworkPacketBufferPool::*func)(IOUserNetworkPacketBufferPool_CopyMemoryDescriptor_Args));\
\
    kern_return_t\
    GetPacketCount_Invoke(const IORPC rpc,\
        kern_return_t (IOUserNetworkPacketBufferPool::*func)(IOUserNetworkPacketBufferPool_GetPacketCount_Args));\
\
    kern_return_t\
    GetBufferCount_Invoke(const IORPC rpc,\
        kern_return_t (IOUserNetworkPacketBufferPool::*func)(IOUserNetworkPacketBufferPool_GetBufferCount_Args));\
\
...
extern OSClassLoadInformation IOUserNetworkPacketBufferPool_Class;
