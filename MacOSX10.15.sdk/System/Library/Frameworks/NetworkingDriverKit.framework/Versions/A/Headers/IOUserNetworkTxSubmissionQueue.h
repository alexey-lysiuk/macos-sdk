/* iig(DriverKit-54.0.0.111.1) generated from IOUserNetworkTxSubmissionQueue.iig */
...
\
    ...
    Create_Invoke(const IORPC rpc,\
        kern_return_t (*func)(IOUserNetworkTxSubmissionQueue_Create_Args));\
\
...
extern OSClassLoadInformation IOUserNetworkTxSubmissionQueue_Class;
