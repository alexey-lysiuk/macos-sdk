 ...
 */
extern CFTypeID 
SKSearchGetTypeID(void)                                       API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKSearchCreate(
  SKIndexRef        inIndex,
  CFStringRef       inQuery,
  SKSearchOptions   inSearchOptions)                          API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern void 
SKSearchCancel(SKSearchRef inSearch)                          API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKSearchFindMatches(
  ...
  CFIndex *        outFoundCount)                             API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKIndexCopyInfoForDocumentIDs(
  ...
  SKDocumentID *  outParentIDsArray)                          API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKIndexCopyDocumentRefsForDocumentIDs(
  ...
  CFIndex          inCount,
  SKDocumentID *   inDocumentIDsArray,
  SKDocumentRef *  outDocumentRefsArray)                      API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKIndexCopyDocumentURLsForDocumentIDs(
  ...
  CFIndex         inCount,
  SKDocumentID *  inDocumentIDsArray,
  CFURLRef *      outDocumentURLsArray)                       API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFTypeID 
SKSearchGroupGetTypeID(void)                                  API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFTypeID 
SKSearchResultsGetTypeID(void)                                API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
...
SKSearchGroupCreate(CFArrayRef inArrayOfInIndexes)            API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFArrayRef 
SKSearchGroupCopyIndexes(SKSearchGroupRef inSearchGroup)      API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
...
SKSearchResultsCreateWithQuery(
  ...
  void *                          inContext,
  SKSearchResultsFilterCallBack   inFilterCallBack)           API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFIndex 
SKSearchResultsGetCount(SKSearchResultsRef inSearchResults)   API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
...
SKSearchResultsGetInfoInRange(
  ...
  float *              outScoresArray)                        API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
...
SKSearchResultsCopyMatchingTerms(
  SKSearchResultsRef   inSearchResults,
  CFIndex              inItem)                                API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
