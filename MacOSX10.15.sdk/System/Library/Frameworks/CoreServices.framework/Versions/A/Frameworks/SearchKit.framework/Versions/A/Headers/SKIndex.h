 ...
 */
extern CFTypeID 
SKIndexGetTypeID(void)                                        API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFTypeID 
SKIndexDocumentIteratorGetTypeID(void)                        API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexCreateWithURL(
  ...
  CFDictionaryRef   inAnalysisProperties)       /* can be NULL */ API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexOpenWithURL(
  CFURLRef      inURL,
  CFStringRef   inIndexName,         /* can be NULL */
  Boolean       inWriteAccess)                                API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexOpenWithData(
  CFDataRef     inData,
  CFStringRef   inIndexName)       /* can be NULL */          API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern Boolean 
SKIndexFlush(SKIndexRef inIndex)                              API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexSetMaximumBytesBeforeFlush(
  SKIndexRef   inIndex,
  CFIndex      inBytesForUpdate)                              API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFIndex 
SKIndexGetMaximumBytesBeforeFlush(SKIndexRef inIndex)         API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern Boolean 
SKIndexCompact(SKIndexRef inIndex)                            API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern SKIndexType 
SKIndexGetIndexType(SKIndexRef inIndex)                       API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexGetAnalysisProperties(SKIndexRef inIndex)              API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFIndex 
SKIndexGetDocumentCount(SKIndexRef inIndex)                   API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern void 
SKIndexClose(SKIndexRef inIndex)                              API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKIndexAddDocumentWithText(
  ...
  Boolean         inCanReplace)                               API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexRemoveDocument(
  SKIndexRef      inIndex,
  SKDocumentRef   inDocument)                                 API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexSetDocumentProperties(
  SKIndexRef        inIndex,
  SKDocumentRef     inDocument,
  CFDictionaryRef   inProperties)                             API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexCopyDocumentForDocumentID(
  SKIndexRef     inIndex,
  SKDocumentID   inDocumentID)                                API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexRenameDocument(
  SKIndexRef      inIndex,
  SKDocumentRef   inDocument,
  CFStringRef     inNewName)                                  API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexMoveDocument(
  SKIndexRef      inIndex,
  SKDocumentRef   inDocument,
  SKDocumentRef   inNewParent)                                API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexDocumentIteratorCreate(
  SKIndexRef      inIndex,
  SKDocumentRef   inParentDocument)                           API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern SKDocumentRef 
SKIndexDocumentIteratorCopyNext(SKIndexDocumentIteratorRef inIterator) API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern SKDocumentID 
SKIndexGetMaximumDocumentID(SKIndexRef inIndex)               API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexGetDocumentTermFrequency(
  ...
  CFIndex        inTermID)                                    API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFIndex 
SKIndexGetMaximumTermID(SKIndexRef inIndex)                   API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKIndexGetTermIDForTermString(
  SKIndexRef    inIndex,
  CFStringRef   inTermString)                                 API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern void 
SKLoadDefaultExtractorPlugIns(void)                           API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
