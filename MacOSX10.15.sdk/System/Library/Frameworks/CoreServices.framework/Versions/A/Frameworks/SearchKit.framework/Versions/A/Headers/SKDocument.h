 ...
 */
extern CFTypeID 
SKDocumentGetTypeID(void)                                     API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKDocumentCreateWithURL(CFURLRef inURL)                       API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFURLRef 
SKDocumentCopyURL(SKDocumentRef inDocument)                   API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
...
SKDocumentCreate(
  ...
  CFStringRef     inName)                                     API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFStringRef 
SKDocumentGetSchemeName(SKDocumentRef inDocument)             API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFStringRef 
SKDocumentGetName(SKDocumentRef inDocument)                   API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern SKDocumentRef 
SKDocumentGetParent(SKDocumentRef inDocument)                 API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
