 ...
 */
extern CFTypeID 
SKSummaryGetTypeID(void)                                      API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern SKSummaryRef 
SKSummaryCreateWithString(CFStringRef inString)               API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFIndex 
SKSummaryGetSentenceCount(SKSummaryRef summary)               API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
 ...
 */
extern CFIndex 
SKSummaryGetParagraphCount(SKSummaryRef summary)              API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKSummaryCopySentenceAtIndex(
  ...
  CFIndex        i)                                           API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKSummaryCopySentenceSummaryString(
  SKSummaryRef   summary,
  CFIndex        numSentences)                                API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKSummaryCopyParagraphSummaryString(
  SKSummaryRef   summary,
  CFIndex        numParagraphs)                               API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKSummaryGetSentenceSummaryInfo(
  ...
  CFIndex *      outParagraphIndexOfSentences)                API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
...
SKSummaryGetParagraphSummaryInfo(
  ...
  CFIndex *      outParagraphIndexOfParagraphs)               API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
