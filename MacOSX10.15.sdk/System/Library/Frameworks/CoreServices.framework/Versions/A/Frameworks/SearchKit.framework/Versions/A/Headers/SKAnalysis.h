 ...
 */
extern const CFStringRef kSKMinTermLength                            API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
/*
 *  kSKSubstitutions
 *  
 *  Summary:
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKSubstitutions                            API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
/*
 *  kSKStopWords
 *  
 *  Summary:
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKStopWords                                API_AVAILABLE( macos(10.3) ) API_UNAVAILABLE( uikitformac );
/*
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKProximityIndexing                        API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
/*
 *  kSKMaximumTerms
 *  
 *  Summary:
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKMaximumTerms                             API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
/*
 *  kSKTermChars
 *  
 *  Summary:
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKTermChars                                API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
/*
 *  kSKStartTermChars
 *  
 *  Summary:
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKStartTermChars                           API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
/*
 *  kSKEndTermChars
 *  
 *  Summary:
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKEndTermChars                             API_AVAILABLE( macos(10.4) ) API_UNAVAILABLE( uikitformac );
/*
 ...
 *    Non-Carbon CFM:   not available
 */
extern const CFStringRef kSKLanguageTypes                            API_DEPRECATED("No longer supported", macos(10.3, 10.4)) API_UNAVAILABLE( uikitformac );
