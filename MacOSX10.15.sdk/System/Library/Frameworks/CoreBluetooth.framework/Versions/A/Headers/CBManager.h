 ...
 *  @constant CBManagerAuthorizationStatusAuthorizedWhileInUse	User has authorized this application to use bluetooth while the application is in use.
...
typedef NS_ENUM(NSInteger, CBManagerAuthorization) {
	...
	CBManagerAuthorizationAllowedWhileInUse,
