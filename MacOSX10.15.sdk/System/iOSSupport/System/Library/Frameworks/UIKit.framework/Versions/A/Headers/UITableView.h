...
} API_DEPRECATED_WITH_REPLACEMENT("UIContextualActionStyle", ios(8.0, 13.0)) API_UNAVAILABLE(tvos);

UIKIT_EXTERN API_DEPRECATED_WITH_REPLACEMENT("UIContextualAction", ios(8.0, 13.0)) API_UNAVAILABLE(tvos)
...
- (BOOL)tableView:(UITableView *)tableView shouldShowMenuForRowAtIndexPath:(NSIndexPath *)indexPath API_DEPRECATED_WITH_REPLACEMENT("tableView:contextMenuConfigurationForRowAtIndexPath:", ios(5.0, 13.0));
- (BOOL)tableView:(UITableView *)tableView canPerformAction:(SEL)action forRowAtIndexPath:(NSIndexPath *)indexPath withSender:(nullable id)sender API_DEPRECATED_WITH_REPLACEMENT("tableView:contextMenuConfigurationForRowAtIndexPath:", ios(5.0, 13.0));
 ...
 */
- (void)tableView:(UITableView *)tableView willCommitMenuWithAnimator:(id<UIContextMenuInteractionCommitAnimating>)animator API_AVAILABLE(ios(13.0)) API_UNAVAILABLE(watchos, tvos);
