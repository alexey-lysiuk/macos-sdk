...
@interface UIBarAppearance (Renamed)

- (void)setupDefaultBackground API_DEPRECATED_WITH_REPLACEMENT("configureWithDefaultBackground", ios(13.0, 13.0), tvos(13.0, 13.0));
- (void)setupOpaqueBackground API_DEPRECATED_WITH_REPLACEMENT("configureWithOpaqueBackground", ios(13.0, 13.0), tvos(13.0, 13.0));
- (void)setupTransparentBackground API_DEPRECATED_WITH_REPLACEMENT("configureWithTransparentBackground", ios(13.0, 13.0), tvos(13.0, 13.0));
