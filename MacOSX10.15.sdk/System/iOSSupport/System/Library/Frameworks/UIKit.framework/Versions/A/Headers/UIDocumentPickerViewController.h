...
typedef NS_ENUM(NSUInteger, UIDocumentPickerUserInterfaceStyle) {
    UIDocumentPickerUserInterfaceStyleWhite = 0,
    UIDocumentPickerUserInterfaceStyleLight,
    UIDocumentPickerUserInterfaceStyleDark,
} API_AVAILABLE(ios(13.0)) API_UNAVAILABLE(macos,watchos,tvos) NS_SWIFT_NAME(UIDocumentPickerViewController.PickerUserInterfaceStyle);
