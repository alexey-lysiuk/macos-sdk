...
@interface UINavigationBarAppearance (Renamed)

@property (nonatomic, readwrite, copy) UIBarButtonItemAppearance *plainButtonAppearance API_DEPRECATED_WITH_REPLACEMENT("buttonAppearance", ios(13.0, 13.0), tvos(13.0, 13.0));
