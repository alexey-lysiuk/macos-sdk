#if USE_UIKIT_PUBLIC_HEADERS || !__has_include(<ShareSheet/UIDocumentInteractionController.h>)
//
...
NS_CLASS_AVAILABLE_IOS(13_0) __TVOS_PROHIBITED @protocol UIDocumentInteractionControllerDelegate <NSObject>
