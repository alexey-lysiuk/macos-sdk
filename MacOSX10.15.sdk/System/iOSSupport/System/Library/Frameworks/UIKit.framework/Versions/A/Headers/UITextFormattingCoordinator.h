...
@property(class, readonly, getter=isFontPanelVisible) BOOL fontPanelVisible API_AVAILABLE(uikitformac(13.0));
...
+ (void)toggleFontPanel:(id)sender API_AVAILABLE(uikitformac(13.0));
