...
UIKIT_EXTERN API_AVAILABLE(ios(5.0)) API_UNAVAILABLE(tvos) @interface UIStepper : UIControl
...
@property(null_resettable,nonatomic,strong) UIColor *tintColor API_AVAILABLE(ios(6.0));
