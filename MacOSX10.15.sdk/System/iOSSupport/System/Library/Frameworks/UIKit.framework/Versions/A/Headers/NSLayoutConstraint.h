...
typedef NS_ENUM(NSInteger, NSLayoutAttribute) {
    ...
    NSLayoutAttributeFirstBaseline API_AVAILABLE(ios(8.0)),
...
typedef NS_OPTIONS(NSUInteger, NSLayoutFormatOptions) {
    ...
    NSLayoutFormatAlignAllFirstBaseline API_AVAILABLE(ios(8.0)) = (1 << NSLayoutAttributeFirstBaseline),
...
UIKIT_EXTERN  NSDictionary *_NSDictionaryOfVariableBindings(NSString *commaSeparatedKeysString, __nullable id firstValue, ...) API_AVAILABLE(ios(6.0)); // not for direct use
 ...
 */
@property (nullable, copy) NSString *identifier API_AVAILABLE(ios(7.0));
