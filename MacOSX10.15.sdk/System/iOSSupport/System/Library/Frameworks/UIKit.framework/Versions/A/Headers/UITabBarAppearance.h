...
@interface UITabBarItemAppearance (Renamed)

- (instancetype)initWithTabBarItemLayout:(UITabBarItemAppearanceStyle)style API_DEPRECATED_WITH_REPLACEMENT("initWithStyle:", ios(13.0, 13.0), tvos(13.0, 13.0));
- (void)setupDefaultAppearanceForStyle:(UITabBarItemAppearanceStyle)style API_DEPRECATED_WITH_REPLACEMENT("configureWithDefaultForStyle:", ios(13.0, 13.0), tvos(13.0, 13.0));
