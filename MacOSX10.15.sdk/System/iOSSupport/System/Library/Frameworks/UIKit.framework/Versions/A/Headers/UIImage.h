...
/*
 * Retrieve a system symbol image with the specified name.
 * This will only return system symbol images. If you want a custom
 * symbol image as defined in your own catalogs, you should use -imageNamed:.
 *
 * Returns nil if an image with specified name doesnt' exist.
 */
 ...
 * as `image`.
 */
- (nullable UIImage *)imageWithConfiguration:(UIImageConfiguration *)configuration API_AVAILABLE(ios(13.0),tvos(13.0),watchos(6.0));
...
@property (class, readonly, strong) UIImage *actionsImage; // currently: white ellipsis on tinted filled circle
@property (class, readonly, strong) UIImage *addImage; // currently: white + on green filled cirlce
@property (class, readonly, strong) UIImage *closeImage; // currently: x-mark
@property (class, readonly, strong) UIImage *removeImage; // currently: white - on red filled circle
