...
@interface UIBarButtonItemAppearance (Renamed)

- (instancetype)initWithBarButtonItemStyle:(UIBarButtonItemStyle)style API_DEPRECATED_WITH_REPLACEMENT("initWithStyle:", ios(13.0, 13.0), tvos(13.0, 13.0));
- (void)setupDefaultAppearanceForStyle:(UIBarButtonItemStyle)style API_DEPRECATED_WITH_REPLACEMENT("configureWithDefaultForStyle:", ios(13.0, 13.0), tvos(13.0, 13.0));
