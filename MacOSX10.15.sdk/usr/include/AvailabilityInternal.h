 ...
 */
    ...
    #define __API_DEPRECATED_PLATFORM_uikitformac(x,y) uikitformac,introduced=x,deprecated=y
    ...
    #define __API_UNAVAILABLE_PLATFORM_uikitformac uikitformac,unavailable
