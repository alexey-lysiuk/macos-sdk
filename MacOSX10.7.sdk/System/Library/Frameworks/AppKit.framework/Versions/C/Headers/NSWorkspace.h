...
- (NSURL *)URLForApplicationToOpenURL:(NSURL *)url NS_AVAILABLE_MAC(10_6);
...
*/
- (NSString *)typeOfFile:(NSString *)absoluteFilePath error:(NSError **)outError NS_AVAILABLE_MAC(10_5);
...
*/
- (NSString *)localizedDescriptionForType:(NSString *)typeName NS_AVAILABLE_MAC(10_5);
...
*/
- (NSString *)preferredFilenameExtensionForType:(NSString *)typeName NS_AVAILABLE_MAC(10_5);
 ...
 */
- (BOOL)setDesktopImageURL:(NSURL *)url forScreen:(NSScreen *)screen options:(NSDictionary *)options error:(NSError **)error NS_AVAILABLE_MAC(10_6);

/* Returns the URL for the desktop image for the given screen.
 */
- (NSURL *)desktopImageURLForScreen:(NSScreen *)screen NS_AVAILABLE_MAC(10_6);
...
- (NSArray *)mountNewRemovableMedia NS_DEPRECATED_MAC(10_0, 10_6);
