 ...
 */
- (nullable NSView *)tableView:(NSTableView *)tableView viewForTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.7));
 ...
 */
- (void)tableView:(NSTableView *)tableView didAddRowView:(NSTableRowView *)rowView forRow:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.7));
 ...
 */
- (void)tableView:(NSTableView *)tableView didRemoveRowView:(NSTableRowView *)rowView forRow:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.7));
 ...
 */ 
- (void)tableView:(NSTableView *)tableView willDisplayCell:(id)cell forTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR;
- (BOOL)tableView:(NSTableView *)tableView shouldEditTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR;
 ...
 */
- (NSString *)tableView:(NSTableView *)tableView toolTipForCell:(NSCell *)cell rect:(NSRectPointer)rect tableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row mouseLocation:(NSPoint)mouseLocation NS_SWIFT_UI_ACTOR;
 ...
 */
- (BOOL)tableView:(NSTableView *)tableView shouldShowCellExpansionForTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));
 ...
 */
- (BOOL)tableView:(NSTableView *)tableView shouldTrackCell:(NSCell *)cell forTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));
 ...
 */
- (nullable NSCell *)tableView:(NSTableView *)tableView dataCellForTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));
 ...
 */
- (BOOL)selectionShouldChangeInTableView:(NSTableView *)tableView NS_SWIFT_UI_ACTOR;
...
*/
- (BOOL)tableView:(NSTableView *)tableView shouldSelectRow:(NSInteger)row NS_SWIFT_UI_ACTOR;
...
*/
- (NSIndexSet *)tableView:(NSTableView *)tableView selectionIndexesForProposedSelection:(NSIndexSet *)proposedSelectionIndexes NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));

- (BOOL)tableView:(NSTableView *)tableView shouldSelectTableColumn:(nullable NSTableColumn *)tableColumn NS_SWIFT_UI_ACTOR;

- (void)tableView:(NSTableView *)tableView mouseDownInHeaderOfTableColumn:(NSTableColumn *)tableColumn NS_SWIFT_UI_ACTOR;
- (void)tableView:(NSTableView *)tableView didClickTableColumn:(NSTableColumn *)tableColumn NS_SWIFT_UI_ACTOR;
- (void)tableView:(NSTableView *)tableView didDragTableColumn:(NSTableColumn *)tableColumn NS_SWIFT_UI_ACTOR;
...
*/
- (CGFloat)tableView:(NSTableView *)tableView heightOfRow:(NSInteger)row NS_SWIFT_UI_ACTOR;
...
*/
- (nullable NSString *)tableView:(NSTableView *)tableView typeSelectStringForTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));
...
*/
- (NSInteger)tableView:(NSTableView *)tableView nextTypeSelectMatchFromRow:(NSInteger)startRow toRow:(NSInteger)endRow forString:(NSString *)searchString NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));
...
*/
- (BOOL)tableView:(NSTableView *)tableView shouldTypeSelectForEvent:(NSEvent *)event withCurrentSearchString:(nullable NSString *)searchString NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));
...
*/
- (BOOL)tableView:(NSTableView *)tableView isGroupRow:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.5));
 ...
 */
- (CGFloat)tableView:(NSTableView *)tableView sizeToFitWidthOfColumn:(NSInteger)column NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.6));
 ...
 */
- (BOOL)tableView:(NSTableView *)tableView shouldReorderColumn:(NSInteger)columnIndex toColumn:(NSInteger)newColumnIndex NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.6));
...
/* Optional - Row actions for a "swipe to delete" feature to show a button on the left or right of a row to do some action (typically deletion).
 ...
 On macOS 13.0 and higher, presentation of the items in the NSTableViewRowAction array take the NSTableView's userInterfaceLayoutDirection into account.
 */
...
- (void)tableViewSelectionDidChange:(NSNotification *)notification NS_SWIFT_UI_ACTOR;
- (void)tableViewColumnDidMove:(NSNotification *)notification NS_SWIFT_UI_ACTOR;
- (void)tableViewColumnDidResize:(NSNotification *)notification NS_SWIFT_UI_ACTOR;
 ...
 */
- (void)tableViewSelectionIsChanging:(NSNotification *)notification NS_SWIFT_UI_ACTOR;
 ...
 */
- (nullable id)tableView:(NSTableView *)tableView objectValueForTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR;
 ...
 */
- (void)tableView:(NSTableView *)tableView setObjectValue:(nullable id)object forTableColumn:(nullable NSTableColumn *)tableColumn row:(NSInteger)row NS_SWIFT_UI_ACTOR;
...
*/
- (void)tableView:(NSTableView *)tableView sortDescriptorsDidChange:(NSArray<NSSortDescriptor *> *)oldDescriptors NS_SWIFT_UI_ACTOR;
 ...
 */
- (nullable id <NSPasteboardWriting>)tableView:(NSTableView *)tableView pasteboardWriterForRow:(NSInteger)row NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.7));
 ...
 */
- (void)tableView:(NSTableView *)tableView draggingSession:(NSDraggingSession *)session willBeginAtPoint:(NSPoint)screenPoint forRowIndexes:(NSIndexSet *)rowIndexes NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.7));
 ...
 */
- (void)tableView:(NSTableView *)tableView draggingSession:(NSDraggingSession *)session endedAtPoint:(NSPoint)screenPoint operation:(NSDragOperation)operation NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.7));
 ...
 */
- (void)tableView:(NSTableView *)tableView updateDraggingItemsForDrag:(id <NSDraggingInfo>)draggingInfo NS_SWIFT_UI_ACTOR API_AVAILABLE(macos(10.7));
...
*/
- (NSDragOperation)tableView:(NSTableView *)tableView validateDrop:(id <NSDraggingInfo>)info proposedRow:(NSInteger)row proposedDropOperation:(NSTableViewDropOperation)dropOperation NS_SWIFT_UI_ACTOR;
...
*/
- (BOOL)tableView:(NSTableView *)tableView acceptDrop:(id <NSDraggingInfo>)info row:(NSInteger)row dropOperation:(NSTableViewDropOperation)dropOperation NS_SWIFT_UI_ACTOR;
