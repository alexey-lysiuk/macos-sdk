...
typedef struct __API_DEPRECATED("Use GSS.framework", macos(10.0, 10.8)) __API_UNAVAILABLE(macCatalyst) krb5plugin_service_locate_ftable {
    ...
    krb5_error_code (*lookup)(void *,
			      ...
			      void *cbdata);
} krb5plugin_service_locate_ftable __API_DEPRECATED("Use GSS.framework", macos(10.0, 10.8)) __API_UNAVAILABLE(macCatalyst);
