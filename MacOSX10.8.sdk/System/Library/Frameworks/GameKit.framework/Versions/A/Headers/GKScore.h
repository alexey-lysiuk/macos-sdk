...
@property(assign, NS_NONATOMIC_IOSONLY)           uint64_t    context              __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_5_0);

@property(readonly, copy, NS_NONATOMIC_IOSONLY)   NSDate      *date;              // The date the score was recorded, defaults to [NSDate date].
@property(readonly, copy, NS_NONATOMIC_IOSONLY)   NSString    *playerID;          // The identifier of the player that recorded the score.
...
@property(assign, NS_NONATOMIC_IOSONLY)            BOOL        shouldSetDefaultLeaderboard     __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_5_0);
