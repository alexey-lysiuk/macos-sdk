...
@property(assign, getter=isHidden, readonly, NS_NONATOMIC_IOSONLY) BOOL hidden;    // Set to NO when a report for that achievement is made. Note: to only unhide an achievement, report it with percentComplete = 0
