...
typedef struct {
    uint16_t x;
    uint16_t y;
} PGDisplayCoord_t API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
typedef void (^PGDisplayModeChangeHandler)(PGDisplayCoord_t sizeInPixels, OSType pixelFormat) API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
typedef void (^PGDisplayNewFrameEventHandler)(void) API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
typedef void (^PGDisplayCursorShowHandler)(BOOL show) API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);

/*!
 @typedef PGDisplayCursorMoveHandler_t
 @abstract A block that will be invoked to handle cursor movement.
 */
typedef void (^PGDisplayCursorMoveHandler)(void) API_AVAILABLE(macos(11.1)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, nullable, copy) NSString *name API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic) NSSize sizeInMillimeters API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, nullable, retain) dispatch_queue_t queue API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, nullable, copy) PGDisplayModeChangeHandler modeChangeHandler API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, nullable, copy) PGDisplayNewFrameEventHandler newFrameEventHandler API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, nullable, copy) PGDisplayCursorGlyphHandler cursorGlyphHandler API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, nullable, copy) PGDisplayCursorShowHandler cursorShowHandler API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, nullable, copy) PGDisplayCursorMoveHandler cursorMoveHandler API_AVAILABLE(macos(11.1)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readonly, nonatomic) PGDisplayCoord_t sizeInPixels API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
 @property(readonly, nonatomic) double refreshRate API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
...
- (nullable PGDisplayMode *)initWithSizeInPixels:(PGDisplayCoord_t)sizeInPixels
                                 refreshRateInHz:(double)refreshRateInHz API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
@end
 ...
 */
@property(readonly, nonatomic, nullable) NSString *name API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readonly, nonatomic) NSSize sizeInMillimeters API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);

/*!
 @property queue
 @abstract The dispatch_queue on which to invoke client supplied blocks.
*/
@property(readonly, nonatomic, nullable) dispatch_queue_t queue API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);

/*!
 @property modeChangeHandler
 @abstract The block to invoke to handle display mode change.
 */
@property(readonly, nonatomic, nullable) PGDisplayModeChangeHandler modeChangeHandler API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
...
/*!
 ...
 @discussion See encodeCurrentFrameToCommandBuffer:texture:region: below to get further processing underway.
 */
@property(readonly, nonatomic, nullable) PGDisplayNewFrameEventHandler newFrameEventHandler API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
...
/*!
 ...
 @abstract The block to invoke to handle cursor show/hide updates.
 */
@property(readonly, nonatomic, nullable) PGDisplayCursorShowHandler cursorShowHandler API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);

/*!
 @property cursorMoveHandler
 @abstract The block to invoke to handle cursor movement.
 */
@property(readonly, nonatomic, nullable) PGDisplayCursorMoveHandler cursorMoveHandler API_AVAILABLE(macos(11.1)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readonly, nonatomic) PGDisplayCoord_t cursorPosition API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readonly, nonatomic) uint32_t serialNum API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
...
/*!
 ...
 @discussion Mostly for debug visibility.  Param of [PGDevice newDisplayWithDescriptor:port:serialNum].
 */
@property(readonly, nonatomic) NSUInteger port API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readonly, nonatomic) MTLTextureUsage minimumTextureUsage API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readonly, nonatomic) NSUInteger guestPresentCount API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readonly, nonatomic) NSUInteger hostPresentCount API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
@property(readwrite, nonatomic, copy, nonnull) NSArray<PGDisplayMode *>  *modeList API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
 ...
 */
- (bool) encodeCurrentFrameToCommandBuffer:(id<MTLCommandBuffer>_Nonnull)commandBuffer texture:(id<MTLTexture>_Nonnull)texture region:(MTLRegion)region API_AVAILABLE(macos(11.0)) API_UNAVAILABLE(ios) API_UNAVAILABLE(tvos);
